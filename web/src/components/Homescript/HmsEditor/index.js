...
const HomescriptLanguage = LRLanguage.define({
    parser: parser.configure({
        props: [
            ...
            styleTags({
                'for while loop if else match try catch return break continue': tags.controlKeyword,
                'in new': tags.operatorKeyword,
                'let fn type trigger': tags.definitionKeyword,
                ...
                'ImportItem/ImportItemCanditate/TriggerImport/Ident': tags.typeName,
                ...
                'TriggerStatement/TriggerTarget/Ident': tags.function(tags.variableName),
                'TriggerConnective': tags.local(tags.controlKeyword),
                'TriggerSource/Ident': tags.typeName,
                'Parameters/Ident': tags.local(tags.variableName),
                'VariableName/Ident': tags.variableName,
                'Annotation/Ident': tags.propertyName,
                ...
                '"(" ")" "{" "}" "[" "]"': tags.bracket,
                '"." ".." "," ";"': tags.separator,
                'AnnotatedFunction/HashTag': tags.local(tags.variableName),
