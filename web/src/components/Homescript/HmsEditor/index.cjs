...
const spec_Ident = {__proto__:null,let:10, true:16, false:16, on:16, off:16, null:40, exit:46, throw:46, assert:46, print:46, println:46, sleep:46, switch_on:46, switch:46, notify:46, log:46, exec:46, get:46, http:46, user:50, weather:50, time:50, if:54, else:60, for:64, in:66, while:70, loop:74, fn:78, try:88, catch:90, as:112, str:116, bool:116, num:116, import:120, from:122, break:126, continue:130, return:134};
